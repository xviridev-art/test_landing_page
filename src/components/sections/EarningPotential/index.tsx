import { ArrowRightIcon, Instagram, Youtube, Music } from "lucide-react";
...
export const EarningPotentialSection = ({ onJoinClick }: EarningPotentialSectionProps): JSX.Element => {
  return (
    <section className="flex w-full items-start justify-center relative overflow-hidden py-20">
      <div className="absolute w-full h-full top-0 left-0 pointer-events-none">
        ...
        <div className="absolute top-[504px] left-[1282px] w-[43px] h-[43px] flex items-center justify-center">
          <Instagram className="w-8 h-8 text-pink-500" />
        </div>
        <div className="absolute top-[115px] left-[1395px] w-[67px] h-[67px] flex items-center justify-center">
          <Music className="w-10 h-10 text-black" />
        </div>
        <div className="absolute top-[157px] left-[1075px] w-[60px] h-[60px] flex items-center justify-center">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-16 w-full">
          <div className="flex flex-col w-full lg:w-[608px] items-start gap-8">
            ...
            >
              ...
              <span className="font-semibold text-green-200 text-[12.6px] tracking-[0] leading-5 font-poppins">
            ...
            <p className="font-semibold text-gray-300 text-[21.4px] tracking-[0] leading-[39px] font-poppins">
              ...
              {features.map((feature, index) => {
                ...
                return (
                  <div key={index} className="inline-flex items-center gap-2">
                    ...
                    <span className="font-semibold text-gray-300 text-[12.6px] tracking-[0] leading-5 whitespace-nowrap font-poppins">
                      {feature.label}
                    </span>
                  </div>
                );
            ...
            <Button onClick={onJoinClick} className="inline-flex h-auto items-center justify-center px-8 py-4 rounded-[14px] overflow-hidden shadow-lg bg-gradient-to-r from-green-500 to-green-700 hover:from-green-400 hover:to-green-600 transition-all">
              <span className="font-semibold text-white text-[15.9px] text-center tracking-[0] leading-7 whitespace-nowrap font-poppins">
                Start Earning Today
              </span>
          ...
          <div className="flex flex-col w-full lg:w-[608px] items-start px-0 lg:px-12 py-0">
            <div className="flex flex-col max-w-lg items-start w-full relative">
                ...
                <CardContent className="flex flex-col items-start gap-4 p-[33px]">
                  <div className="flex items-center justify-between w-full">
                    <div className="inline-flex items-center gap-3">
                      <div className="flex w-[23.04px] h-[28.43px] items-center justify-center bg-gradient-to-br from-green-400 to-green-600 rounded">
                        <div className="w-2.5 h-5" />
                      </div>
                      ...
                      <div className="inline-flex flex-col items-start">
                        ...
                        <span className="font-normal text-gray-400 text-[12.1px] tracking-[0] leading-5 whitespace-nowrap font-poppins">
                          Content Creator!
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="inline-flex flex-col items-end">
                      ...
                      <span className="font-normal text-gray-400 text-[12.5px] text-right tracking-[0] leading-5 whitespace-nowrap font-poppins">
                        This month
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start justify-center gap-4 pt-[17px] w-full border-t border-gray-700/20">
                    {stats.map((stat, index) => (
                      ...
                      >
                        ...
                        <span className="font-normal text-gray-400 text-[10.5px] text-center tracking-[0] leading-4 font-poppins">
                          {stat.label}
                        </span>
                      </div>
                    ))}
              ...
              <Badge className="inline-flex items-center px-[17px] py-[9px] absolute -left-4 -bottom-4 bg-white/10 rounded-full overflow-hidden border border-gray-700/20 shadow-lg backdrop-blur-sm h-auto hover:bg-white/20">
                <span className="font-semibold text-white text-[13.5px] tracking-[0] leading-5 whitespace-nowrap font-poppins">
                  ⭐ 4.9/5 Rating
                </span>
              </Badge>
            </div>
