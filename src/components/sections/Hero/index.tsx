...
const statsCards = [
  {
    ...
    badge: "+15% this month",
    gradient:
      "linear-gradient(0deg,rgba(0,188,125,0.07)_0%,rgba(0,188,125,0.07)_100%)",
  ...
  },
  {
    ...
    gradient:
      "linear-gradient(0deg,rgba(43,127,255,0.1)_0%,rgba(43,127,255,0.1)_100%)",
  ...
  },
  {
    ...
    badge: "Growing daily",
    gradient:
      "linear-gradient(0deg,rgba(255,248,43,0.1)_0%,rgba(255,248,43,0.1)_100%)",
  ...
  },
  {
    ...
    badge: "New weekly",
    gradient:
      "linear-gradient(0deg,rgba(212,0,0,0.07)_0%,rgba(212,0,0,0.07)_100%)",
...
export const HeroSection = (): JSX.Element => {
  return (
    <section className="relative w-full px-4 md:px-20 lg:px-80 py-24">
      ...
      <div className="relative max-w-screen-xl w-full mx-auto">
        <header className="flex flex-col w-full items-center gap-6 mb-24">
          ...
          >
            ...
            <span className="font-semibold text-green-200 text-[12.5px] leading-5 font-poppins">
          ...
          {statsCards.map((card, index) => {
            ...
            return (
              <Card
                ...
                style={{
                  background: `linear-gradient(126deg,rgba(255,255,255,0.05)_0%,rgba(255,255,255,0.1)_100%), ${card.gradient}`,
                }}
              >
                <CardContent className="flex flex-col gap-6 p-[33px]">
                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    <div className="flex flex-col gap-[6.88px]">
                      ...
                      <p className="font-normal text-gray-300 text-[12.5px] tracking-[0] leading-[22.8px] whitespace-pre-line font-poppins">
                        {card.description}
                      </p>
                    </div>
                    ...
                    <div className="flex items-center pt-[17px] border-t border-gray-700/20">
                      <div className="inline-flex items-center gap-1">
                        ...
                        <span className="font-semibold text-green-200 text-[12.5px] tracking-[0] leading-5 font-poppins">
                          {card.badge}
                        </span>
                      </div>
                    </div>
        ...
        <footer className="flex flex-col w-full items-center">
          ...
          >
            ...
            <span className="text-green-200 text-[12.4px] leading-5 font-semibold font-poppins">
