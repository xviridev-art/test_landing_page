      ...
      <div className="relative max-w-screen-lg mx-auto">
        <Card className="overflow-hidden border-gray-700/20 shadow-xl backdrop-blur-md bg-gradient-to-br from-white/5 to-white/10">
          <CardContent className="relative p-12 md:p-16 flex flex-col items-center gap-8">
            <Badge className="border-green-400 bg-gradient-to-r from-green-900/50 to-green-800/50 text-green-200 hover:bg-gradient-to-r hover:from-green-800/60 hover:to-green-700/60 h-auto px-[17px] py-[9px] rounded-full">
              <CheckCircle className="w-4 h-4 mr-2 text-green-400" />
              <span className="font-semibold text-[12.5px] leading-5 font-poppins">
                Join the Creator Revolution
              </span>
            </Badge>

            <div className="flex flex-col items-center gap-6 max-w-screen-md w-full">
              <h2 className="font-semibold text-white text-[32px] md:text-[40px] leading-tight text-center font-poppins">
                Ready to Monetize Your
                <br />
                Roblox Content?
              </h2>

              <p className="font-semibold text-gray-300 text-[21.4px] leading-[39px] text-center font-poppins">
              ...
              {features.map((feature, index) => {
                ...
                return (
                  <div key={index} className="inline-flex items-center gap-2">
                    ...
                    <span className="font-semibold text-gray-300 text-[12.5px] leading-5 whitespace-nowrap font-poppins">
                      {feature.text}
                    </span>
                  </div>
                );
            ...
            <div className="flex flex-col items-center gap-4">
              <Button onClick={onJoinClick} className="h-auto px-8 py-4 shadow-lg bg-gradient-to-r from-green-500 to-green-700 hover:from-green-400 hover:to-green-600 rounded-[14px] transition-transform hover:scale-105">
              ...
              <p className="font-normal text-gray-400 text-[12.5px] text-center leading-5 font-poppins">
